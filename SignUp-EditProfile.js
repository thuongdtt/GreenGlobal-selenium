...
client
  ...
  .submitForm(".signin-signup-form.step-1 form").then(function(res){
	...
	.pause(1000)
	.click('div.user-logged ul li:nth-child(5) div.dropdown-menu ul li:nth-child(2)')
	.pause(1000)
	.setValue('input#inputFirstName', Math.floor((Math.random() * 10000000000) + 1) )
	.setValue('input#inputLastName', Math.floor((Math.random() * 10000000000) + 1) )
	.setValue('input#inputTelephoneNumber', "11111111" )
	.setValue('input#inputCompanyName',  makeid(20) )
	.pause(1000)
	.click('button.btn.dropdown-toggle.selectpicker.btn-default')
	.pause(500)
	.click('ul.dropdown-menu.inner.selectpicker li:nth-child('+Math.floor((Math.random() * 12) + 2)+')')
	.click('.profile-footer-form.text-center button:nth-child(2)')
	.pause(10000)
	.end();
